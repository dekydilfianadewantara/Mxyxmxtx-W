...
class HanyaNexmo {
	...
	public static function NexmoMessage ($api_key, $api_secret) {
		$this->nx_key = $api_key;
		$this->nx_secret = $api_secret;
	}

	public static function anak(){
		return 'dd';
	}
	 ...
	 * unicode characters.
	 */
	public static function sendText ( $to, $from, $message, $unicode=null ) {
	 ...
	 */
	public static function sendBinary ( $to, $from, $body, $udh ) {
	 ...
	 */
	public static function pushWap ( $to, $from, $title, $url, $validity = 172800000 ) {
	 ...
	 */
	private static function normaliseKeys ($obj) {
	 ...
	 */
	private static function nexmoParse ( $from_nexmo ) {
	 ...
	 */
	private static function validateOriginator($inp){
	 ...
	 */
	public static function displayOverview( $nexmo_response=null ){
	 ...
	 */
	public static function inboundText( $data=null ){
		if(!$data) $data = $_GET;
