...
<head>
  ...
  <script src="{{asset('assets/js/AdminLTE/modernizr-2.6.2.min.js')}}"></script>
</head>
<body>
  ...
  <script src="{{asset('assets/js/AdminLTE/brain-socket.min.js')}}"></script>
  <script type="text/javascript" charset="utf-8">
    $(function(){
      ...
      // app.BrainSocket.Event.listen('app.insert',function(data){
